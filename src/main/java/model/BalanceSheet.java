...
public class BalanceSheet{
    ...
    public void setAccountPayables(double accountPayables) {
    ...
    public double getAccumulatedOtherComprehensiveIncomeLoss() {
        return accumulatedOtherComprehensiveIncomeLoss;
    }

    public void setAccumulatedOtherComprehensiveIncomeLoss(double accumulatedOtherComprehensiveIncomeLoss) {
        this.accumulatedOtherComprehensiveIncomeLoss = accumulatedOtherComprehensiveIncomeLoss;
    }

    public double getOthertotalStockholdersEquity() {
        return othertotalStockholdersEquity;
    }

    public void setOthertotalStockholdersEquity(double othertotalStockholdersEquity) {
    ...
    public double getTotalLiabilitiesAndStockholdersEquity() {
        return totalLiabilitiesAndStockholdersEquity;
    }

    public void setTotalLiabilitiesAndStockholdersEquity(double totalLiabilitiesAndStockholdersEquity) {
